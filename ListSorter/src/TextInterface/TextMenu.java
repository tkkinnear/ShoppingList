...
import storemanager.Department;
...
public class TextMenu {
    ...
    private boolean updateProduct(String n) {
        // THIS SHOULD PROBABLY BE UPDATED TO MOSTLY MIGRATE TO STOREMANAGER CLASS
        while (true) {
    ...
    private Product newProduct(){
        // gets name for new item from TextCommand class
    ...
    private void validateList() {
        List<String> failed = shoppingList.checkList(store);
